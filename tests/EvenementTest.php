...
class EvenementTest extends WebTestCase
{
    public function testLoggedUserCanCreateEvenementwITHcATEGORIE(): void
    {
        ...
        //gestion d'un token car Symfony protège le formulaire avec un tocken. Il faut lui fournir lors du test de création.
